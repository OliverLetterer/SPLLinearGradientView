...
#define COCOAPODS_POD_AVAILABLE_SPLLinearGradientView
#define COCOAPODS_VERSION_MAJOR_SPLLinearGradientView 0
#define COCOAPODS_VERSION_MINOR_SPLLinearGradientView 1
#define COCOAPODS_VERSION_PATCH_SPLLinearGradientView 0
